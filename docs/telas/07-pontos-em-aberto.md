...
## 1. Painel da Clara (a conversa em si) — RESOLVIDO (desenho da tela)

**Status: design da tela fechado em [08-painel-clara.md](./08-painel-clara.md).**
...
**Arquitetura do agente:** fechada em [../06-agente-clara.md](../06-agente-clara.md) —
