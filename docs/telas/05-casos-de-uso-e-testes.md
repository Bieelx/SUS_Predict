...
| "Quero entender o porquê de um alerta sem precisar interpretar gráfico" | Visão Geral, Camada 2 (texto Clara) + Alertas, Camada 2 (evidência inline) |
...
2. Texto da Clara (Camada 2) já menciona a Dipirona especificamente
...
| T02 | Visão Geral | Idem T01 | Ler o texto da Clara (Camada 2) | Texto cita o medicamento e o prazo específicos, não um resumo genérico | ✅ Funcional |
