...
O texto técnico gerado automaticamente (apoio de IA, mesma lógica da Clara/Gemini)
...
| Justificativa técnica (Etapa 3) | Geração via IA (Gemini, mesma integração da Clara), a partir dos dados da Etapa 1 |
